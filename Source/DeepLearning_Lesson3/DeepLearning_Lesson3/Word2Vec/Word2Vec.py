...
def fetch_words_data(url=data_url, words_data=data_dir):
    ...
    # Path to zip file 
    zip_path = os.path.join(words_data, "words2.zip")
...
# Dimension of embedding vector (changed from 150 to 50)
embedding_size = 150
...
# Random set of words to evaluate similarity on. changed from 16 to 32
valid_size = 32
...
# Construct the Adam optimizer (changed from 1 to 0.1)
...
# training takes a long time! changed from 200000 to 5000
num_steps = 5000
